...
public class PostHomeRouteTest {
   ...
   */
     ...
     */
    @Test
    public void test_challenge_request_no_opponentname_in_querystring(){
        ...
        // OPPONENT_NAME_ATTR should have the other player name
        when(request_ch.queryParams(CuT.OPERATION_ATT)).thenReturn(String.valueOf(CHALLENGE_OPERATION_NUM_one));
        when(request_ch.queryParams(CuT.OPPONENT_NAME_ATTR)).thenReturn(null);
        final Response response = mock(Response.class);
...
//     */
//    @Test
//    public void test_challenge_request_no_opponentname(){
//
//        //mimic a POST request with OPERATION_ATT = 1 to page
//        // validate PLAYER_CHALLENGE_STATUS, IS_CHALLENGED_ATTR, OPPONENT_NAME_ATTR
//        // PLAYER_CHALLENGE_STATUS has the current challenge state for the player
...
//        // OPPONENT_NAME_ATTR should have the other player name
//        when(request_ch.queryParams(CuT.OPERATION_ATT)).thenReturn(String.valueOf(CHALLENGE_OPERATION_NUM_one));
//        when(request_ch.queryParams(CuT.OPPONENT_NAME_ATTR)).thenReturn("tony");
//        //when(gameCenter.challengePlayer(request_ch.session(),opponentName)).thenReturn(false);
//        final Response response = mock(Response.class);
//
//
//        //Get Results for challenger
...
//    }
     ...
     */
    @Test
    public void test_challenge_accept_request(){
        ...
        gameCenter.challengePlayer(session_ch,opponentName);
        when(request_op.queryParams(PostHomeRoute.OPERATION_ATT)).thenReturn(String.valueOf(CHALLENGE_OPERATION_NUM_three));
        assertSame(gameCenter.getChallengeStatus(challenger),Challenge.State.CHALLENGE_PENDING);
        final Response response = mock(Response.class);
        //Get Results
        final ModelAndView result = CuT.handle(request_op,response);
